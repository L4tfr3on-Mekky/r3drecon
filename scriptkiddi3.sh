...
banner () {
  ...
  ____  _____     _   ____
                ...
                | |_) | |_ \ / _` | | |_) / _ \/ __/ _ \| '_ \
                |  _ < ___) | (_| | |  _ <  __/ (_| (_) | | | |
                |_| \_\____/ \__,_| |_| \_\___|\___\___/|_| |_|
                                                                                    

                            V 1.0 (beta)
                            Coded By r00tfr3on(Mekky)  ❤
    "$reset""


    printf ""$lred"
Twitter   :-   https://twitter.com/r00tfr3on
Face book :- https://www.facebook.com/r00tfr3on/
Linkedin  :-  https://www.linkedin.com/in/abdelrahem-hussien-0917871a6/
"$reset""
echo -e "\n"
}
